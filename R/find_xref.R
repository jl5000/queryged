...
#' @examples 
#' find_xref(tidyged::sample555, c(INDI.BURI.PLAC = "Spring Hill"), multiple = FALSE)
#' find_xref(tidyged::sample555, c(INDI.SEX = "M"), multiple = TRUE)
#' find_xref(tidyged::sample555, c(FAM.MARR.DATE = "1859"), multiple = FALSE)
#' find_xref(tidyged::sample555, c(REPO.ADDR.CITY = "Salt Lake"), multiple = TRUE)
#' find_xref(tidyged::sample555, c(INDI.NAME.SURN = "Williams", INDI.ADOP.DATE = "Never"), 
#' mode = "best", multiple = TRUE)
#' @export
#' @tests
#' expect_error(find_xref(tidyged::sample555, character()))
#' expect_error(find_xref(tidyged::sample555, c(INDI.NAME = "test"), mode = "foo"))
#' expect_error(find_xref(tidyged::sample555, letters[1:5]))
#' expect_error(find_xref(tidyged::sample555, c(a = "das", "sd", b = "r42")))
#' expect_error(find_xref(tidyged::sample555, c(INDI.SEX = "L")))
#' expect_error(find_xref(tidyged::sample555, c(INDI.NAME.SURN = "Williams")))
#' expect_equal(find_xref(tidyged::sample555, c(FAM.MARR.DATE = "1859")), "@F1@")
#' expect_equal(find_xref(tidyged::sample555, c(INDI.SEX = "M", INDI.NAME.SURN = "Williams", INDI.BIRT.PLAC = "Falls")), "@I3@")
...
#' @examples 
#' find_indi_name(tidyged::sample555, "Mary")
#' find_indi_name_all(tidyged::sample555, "Williams")
#' find_repo_name(tidyged::sample555, "library", ignore_case = TRUE)
#' find_sour_titl(tidyged::sample555, "Madison.+Records")
#' @export
